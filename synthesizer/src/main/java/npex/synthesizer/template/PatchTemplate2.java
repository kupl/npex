...
public abstract class PatchTemplate2 {
  static Logger logger = LoggerFactory.getLogger(PatchTemplate2.class);
  ...
  public PatchTemplate2(String id, CtExpression nullExp) {
    this.id = id;
